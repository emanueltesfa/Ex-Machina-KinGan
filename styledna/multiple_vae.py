...
def main(args):
	...
	with torch.no_grad():
		...
		for i in range(5):
			...
			save_image((sImg_hat+1)/2, f'{args.outputs}/result_{args.target_gender}_{args.target_age}_{i}.png', nrow = 1)    
			print(f'{args.outputs}/result_vae_{args.target_gender}_{args.target_age}_V{i + 1}.png downloaded')
